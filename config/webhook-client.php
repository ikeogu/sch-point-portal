...
use App\Services\Webhook\Handler\PaystackHandler;
use App\Services\Webhook\Validator\PaystackSignatureValidator;
...
return [
    'configs' => [
        [
             ...
             */
            'signing_secret' => config('services.paystack.secret'),
             ...
             */
            'process_webhook_job' => PaystackHandler::class,
        ],
    ],
